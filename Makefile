...
#	docker buildx build --load --platform linux/arm64 -f Dockerfile --build-arg BUILDER_IMAGE=ghcr.io/andriykalashnykov/dlib-docker:v19.24.4 --build-arg GO_VER=1.25.3 -t ghcr.io/andriykalashnykov/go-face:arm64 --push .
